...
ID3D11PixelShader* gMotionBlurProcess = nullptr;
...
bool LoadShaders()
{
	...
	gMotionBlurProcess = LoadPixelShader("MotionBlur_pp");
...
void ReleaseShaders()
{
	if (gMotionBlurProcess)  gMotionBlurProcess->Release();
